...
PARSED_JSON_PATH = PARSED_DIR / "招股说明书2_原始文本.json"
CHUNKS_DIR = DATA_DIR / "chunks"
CHUNKS_JSONL_PATH = CHUNKS_DIR / "招股说明书2_分块.jsonl"
EMBEDDINGS_JSONL_PATH = CHUNKS_DIR / "招股说明书2_带向量.jsonl"
...
REBUILD_COLLECTION = True  # 重建集合，删除旧数据重新导入

# =============================================================================
# VLM图表理解配置
# =============================================================================
# 使用视觉语言模型理解图表结构（替换原始OCR）
VLM_CONFIG_PATH = PROJECT_DIR / "offline" / "vlm_config.json"
