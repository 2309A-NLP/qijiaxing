...
MINERU_PYTHON="D:/an/envs/project2/python.exe"
...
# ---------- 1. MinerU解析PDF ----------
echo ""
echo "[Step 1/4] MinerU解析PDF: $KB_NAME"
$MINERU_PYTHON offline/parse_pdf_mineru.py "$KB_NAME"

# ---------- 2. 文本分块 ----------
echo ""
echo "[Step 2/4] 文本分块: $KB_NAME"
$MINERU_PYTHON offline/chunk_text.py "$KB_NAME"

# ---------- 3. 向量化 ----------
echo ""
echo "[Step 3/4] 向量化: $KB_NAME"
$MINERU_PYTHON offline/generate_embeddings.py "$KB_NAME"

# ---------- 4. 导入Milvus ----------
echo ""
echo "[Step 4/4] 导入Milvus: $KB_NAME"
$MINERU_PYTHON offline/import_to_milvus.py "$KB_NAME"

echo ""
echo "=========================================="
echo "  KB '$KB_NAME' 全流程执行完成！"
echo "  解析→分块→向量化→导入Milvus 全部完成"
echo "=========================================="
